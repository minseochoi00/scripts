...
# Button 1
    ...
    # Update Button Color back to White
        ...
        $Button3.Add_Click({
            ...
            # Code to run when Button 3 is clicked
                ...
                # Create a Progress Bar
                    ...
                    $ProgressBar2.Location = New-Object System.Drawing.Point (25, 35)
                    $ProgressBar2.Size = New-Object System.Drawing.Size (100, 15)
                    $ProgressBar2.Minimum = 0
                    $ProgressBar2.Maximum = 100
                    $ExtraForm.Controls.Add($ProgressBar2)
            ...
            # Create a label to display which button finished running its script
                ...
                $Label.Location = New-Object System.Drawing.Point(155, 15)
...
# Create a Progress Bar
    ...
    $ProgressBar1.Location = New-Object System.Drawing.Point (25, 230)
    $ProgressBar1.Size = New-Object System.Drawing.Size (100, 15)
